...
.btn-primary:hover {
  background-color: rgb(212 5 17 / 0.9);
}
.btn-primary:focus {
...
.btn-secondary:focus {
  ...
  box-shadow: var(--tw-ring-offset-shadow), var(--tw-ring-shadow), var(--tw-shadow, 0 0 #0000);
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(212 5 17 / var(--tw-ring-opacity, 1));
  --tw-ring-offset-width: 2px;
}
.card {
...
.divide-dhl-red\/20 > :not([hidden]) ~ :not([hidden]) {
  border-color: rgb(212 5 17 / 0.2);
}
...
.border-dhl-red {
  --tw-border-opacity: 1;
  border-color: rgb(212 5 17 / var(--tw-border-opacity, 1));
}
.border-dhl-red\/30 {
  border-color: rgb(212 5 17 / 0.3);
}
.border-dhl-red\/40 {
  border-color: rgb(212 5 17 / 0.4);
}
.border-dhl-red\/50 {
  border-color: rgb(212 5 17 / 0.5);
}
...
.bg-dhl-yellow\/5 {
  background-color: rgb(255 204 0 / 0.05);
}
.bg-emerald-100 {
  --tw-bg-opacity: 1;
...
.to-slate-100\/90 {
  --tw-gradient-to: rgb(241 245 249 / 0.9) var(--tw-gradient-to-position);
}
.to-slate-50 {
...
.ring-dhl-red\/30 {
  --tw-ring-color: rgb(212 5 17 / 0.3);
}
.ring-indigo-500 {
  --tw-ring-opacity: 1;
...
.hover\:bg-dhl-red:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(212 5 17 / var(--tw-bg-opacity, 1));
}

.hover\:bg-dhl-red\/90:hover {
  background-color: rgb(212 5 17 / 0.9);
}

.hover\:bg-dhl-yellow\/10:hover {
  background-color: rgb(255 204 0 / 0.1);
}

.hover\:bg-dhl-yellow\/20:hover {
  background-color: rgb(255 204 0 / 0.2);
}

.hover\:bg-dhl-yellow\/25:hover {
  background-color: rgb(255 204 0 / 0.25);
}

.hover\:bg-dhl-yellow\/50:hover {
...
.hover\:text-dhl-red:hover {
  --tw-text-opacity: 1;
  color: rgb(212 5 17 / var(--tw-text-opacity, 1));
}

.hover\:text-dhl-red\/80:hover {
  color: rgb(212 5 17 / 0.8);
}
...
.focus\:ring-dhl-red:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(212 5 17 / var(--tw-ring-opacity, 1));
}

.focus\:ring-dhl-yellow:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(255 204 0 / var(--tw-ring-opacity, 1));
}
...
.group\/milestone-card:focus-within .group-focus-within\/milestone-card\:opacity-100 {
  opacity: 1;
}

.group\/product-header:focus-within .group-focus-within\/product-header\:opacity-100 {
  opacity: 1;
}
...
.group\/version-section:focus-within .group-focus-within\/version-section\:opacity-100 {
  opacity: 1;
}

.group\/row:hover .group-hover\/row\:border-indigo-300 {
  --tw-border-opacity: 1;
  border-color: rgb(165 180 252 / var(--tw-border-opacity, 1));
}

.group\/row:hover .group-hover\/row\:bg-indigo-50 {
  --tw-bg-opacity: 1;
  background-color: rgb(238 242 255 / var(--tw-bg-opacity, 1));
}

.group\/group-label:hover .group-hover\/group-label\:opacity-100 {
  opacity: 1;
}

.group\/milestone-card:hover .group-hover\/milestone-card\:opacity-100 {
  opacity: 1;
}

.group\/product-header:hover .group-hover\/product-header\:opacity-100 {
  opacity: 1;
}
...
.group\/version-section:hover .group-hover\/version-section\:opacity-100 {
  opacity: 1;
}
...
.group\/row:hover .group-hover\/row\:shadow {
  --tw-shadow: 0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1);
  --tw-shadow-colored: 0 1px 3px 0 var(--tw-shadow-color), 0 1px 2px -1px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
